      ...
      <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          <div className="col-span-full lg:col-span-1">
            <Link
              to="/"
              className="flex-none rounded-xl text-xl lg:text-3xl font-semibold focus:outline-none focus:opacity-80 font-playfair-display"
              aria-label="BitePlus"
            >
              <svg
          ...
          <div className="col-span-1">
            <h4 className="font-semibold text-gray-100">Our Address</h4>

            <div className="mt-3 grid space-y-3">
              <p className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200">
                625 @ Neo Blake Road, <br /> Artland, Craft 14536, BD
              </p>
              <p className="inline-flex items-center gap-x-2 text-gray-400 hover:text-gray-200">
                <FaPhone />
                +880 17589-02584
              </p>
              <p className="inline-flex items-center gap-x-2 text-gray-400 hover:text-gray-200">
        ...
        <div className="mt-5 sm:mt-12 gap-y-2 sm:gap-y-0 flex justify-between items-center flex-wrap">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-400">
              © 2024 BitesPlus. All rights reserved.
            </p>
          </div>
          {/* <!-- End Col --> */}
